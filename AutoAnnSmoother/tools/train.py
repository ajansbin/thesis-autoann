...
def main(config:str, data_path:str, pc_name:str, save_dir:str, result_path:str, name:str, anno_path:str):
    trainer = SmoothingTrainer(result_path, config, data_path, pc_name, save_dir, name, anno_path)
    trainer.load_data()
    trainer.load_model()
    trainer.train()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pc-name', type=str, default="preprocessed_full_train", help="Name of folder where pc are stored")
    parser.add_argument('--anno-path', type=str, default="", help="Path to annotation json file, if empty use zod AnnotationProject")
    ...
    main(args.config, args.data_path, args.pc_name, args.save_dir, args.result_path, args.name, args.anno_path)