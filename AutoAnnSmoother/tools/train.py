...
def main(config:str, data_path:str, pc_name:str, save_dir:str, result_path:str, name:str):
...
if __name__ == '__main__':
    ...
    main(args.config, args.data_path, args.pc_name, args.save_dir, args.result_path, args.name)