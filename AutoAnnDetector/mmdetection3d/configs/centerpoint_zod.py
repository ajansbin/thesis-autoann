...
model = dict(
    ...
    pts_middle_encoder=dict(
        type='PointPillarsScatter', in_channels=128, output_shape=(1024, 512)),
    pts_backbone=dict(
        type='SECOND',
        in_channels=128,
    ...
    pts_bbox_head=dict(
        ...
        in_channels=384,
        tasks=[
            dict(num_class=1, class_names=class_names),
        ],
        common_heads=dict(
        ...
        bbox_coder=dict(
            ...
            post_center_range=[-61.2, -61.2, -10.0, 61.2, 224.8, 10.0],
            max_num=500,
            score_threshold=0.1,
            out_size_factor=2,
            voxel_size=[0.2, 0.2],
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='zod_single_vehicle_pcr200'),
